...
const AgentArchitecture: React.FC = () => {
  return (
    <Section id="ai-agent-architecture">
      ...
      <p>The Model Context Protocol (MCP) standardises JSON‑RPC 2.0 over stdio so agents can safely enumerate & invoke tools. Aegis automates validation of each lifecycle phase and the structural guarantees required for reliable orchestration:</p>
      ...
      <Callout type="info" title="AI Agent Integration Flow" className="mb-6">
        ...
        <p className="text-sm">Aegis validates startup, handshake, tool discovery, execution results & error semantics end‑to‑end.</p>
      </Callout>
