...
const RealWorldExamples: React.FC = () => {
  return (
    <Section id="real-world-examples">
      ...
      <H3 id="multi-tool-yaml">Real YAML Tests (multi-tool-server) <a className="ml-2 text-xs text-blue-600 underline" target="_blank" rel="noopener noreferrer" href="https://github.com/taurgis/mcp-aegis/tree/main/examples/multi-tool-server">(view repo)</a></H3>
