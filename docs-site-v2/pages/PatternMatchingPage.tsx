            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="text-left p-3 border border-gray-300 font-semibold">Pattern Type</th>
                            <th className="text-left p-3 border border-gray-300 font-semibold">Syntax</th>
                            <th className="text-left p-3 border border-gray-300 font-semibold">Description</th>
                            <th className="text-left p-3 border border-gray-300 font-semibold">Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr className="border-b"><td className="p-3 border border-gray-300"><strong>Type Validation</strong></td><td className="p-3 border border-gray-300"><InlineCode>"match:type:string"</InlineCode></td><td className="p-3 border border-gray-300">Validates data type</td><td className="p-3 border border-gray-300">✅ Verified</td></tr>
                        <tr className="border-b"><td className="p-3 border border-gray-300"><strong>String Contains</strong></td><td className="p-3 border border-gray-300"><InlineCode>"match:contains:text"</InlineCode></td><td className="p-3 border border-gray-300">String contains substring</td><td className="p-3 border border-gray-300">✅ Verified</td></tr>
                        <tr className="border-b"><td className="p-3 border border-gray-300"><strong>String Starts With</strong></td><td className="p-3 border border-gray-300"><InlineCode>"match:startsWith:prefix"</InlineCode></td><td className="p-3 border border-gray-300">String starts with prefix</td><td className="p-3 border border-gray-300">✅ Verified</td></tr>
                        <tr className="border-b"><td className="p-3 border border-gray-300"><strong>String Ends With</strong></td><td className="p-3 border border-gray-300"><InlineCode>"match:endsWith:suffix"</InlineCode></td><td className="p-3 border border-gray-300">String ends with suffix</td><td className="p-3 border border-gray-300">✅ Verified</td></tr>
                        <tr className="border-b"><td className="p-3 border border-gray-300"><strong>Regex Match</strong></td><td className="p-3 border border-gray-300"><InlineCode>"match:regex:pattern"</InlineCode></td><td className="p-3 border border-gray-300">Regular expression match</td><td className="p-3 border border-gray-300">✅ Verified</td></tr>
