...
export function matchPattern(pattern, actual) {
  ...
  const patternHandlers = {
    ...
    'stringLength:': handleStringLengthPattern,
    'stringLengthGreaterThan:': handleStringLengthGreaterThanPattern,
    'stringLengthLessThan:': handleStringLengthLessThanPattern,
    'stringLengthGreaterThanOrEqual:': handleStringLengthGreaterThanOrEqualPattern,
    'stringLengthLessThanOrEqual:': handleStringLengthLessThanOrEqualPattern,
    'stringLengthBetween:': handleStringLengthBetweenPattern,
    'stringEmpty': handleStringEmptyPattern,
    'stringNotEmpty': handleStringNotEmptyPattern,
